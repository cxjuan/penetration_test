...
for env in envs:
    ...
    print("=========== joint =============")
    common = list(info_dict["DQN"] & info_dict["Constrained_DQN"] & info_dict["Random"] & info_dict["RuleBased"])        # strings found in both
    unique_DQN = list(info_dict["DQN"] - info_dict["Constrained_DQN"] - info_dict["Random"] - info_dict["RuleBased"])       # only in a
    unique_Constrained_DQN = list(info_dict["Constrained_DQN"] - info_dict["DQN"] - info_dict["Random"] - info_dict["RuleBased"])       # only in b
    unique_Random = list(info_dict["Random"] - info_dict["DQN"] - info_dict["Constrained_DQN"] - info_dict["RuleBased"]) # only in a
    unique_RuleBased = list(info_dict["RuleBased"] - info_dict["Constrained_DQN"] - info_dict["DQN"] - info_dict["Random"])
